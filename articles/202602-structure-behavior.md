...
「早く作る」と「正しく作る」——この二つはトレードオフの関係にあると思われがちだ。スピードを優先すれば品質が犠牲になり、品質を追求すれば開発が遅くなる。多くの開発現場でこの二項対立が前提として語られている。

しかし、私はこの前提に疑問を持っている。**アジリティと品質は、適切な設計によって両立できる**のではないか。
